...
namespace ContosoUniversity.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            // Commented out the previous async code in order to do a raw SQL query
        ...
        public async Task<ActionResult> Create([Bind(Include = "DepartmentID,Name,Budget,StartDate,InstructorID,RowVersion")] Department department)
        {
        ...
        public async Task<ActionResult> Edit(int? id, byte[] rowVersion)
        {
            ...
            if (TryUpdateModel(departmentToUpdate, fieldsToBind))
            {
                ...
                {
                    //Log the error (uncommnet dex variable name and add a line here to write a log.
